      ...
      <label>
        <input
          ...
          className={classNames(
            ...
            {
              "w-5 h-5 before:w-5 before:h-5 before:border-2 before:hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] after:left-1.5 after:top-0.5 after:w-2 after:h-3 after:border-r-2 after:border-b-2":
                size === "sm",
            },
            {
              "w-10 h-10 before:w-8 before:h-8 before:border-4 before:hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] after:left-2.5 after:top-1.5 after:w-3 after:h-4 after:border-r-4 after:border-b-4":
                size === "lg",
            },
